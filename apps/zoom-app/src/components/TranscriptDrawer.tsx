...
function TranscriptDrawer({ open, transcript, onToggle }: TranscriptDrawerProps) {
  ...
  return (
    <aside className="relative w-[52px] shrink-0 border-l border-ink/10 bg-white/70 dark:bg-slate-950">
      ...
      {open ? (
        <div className="absolute right-0 top-0 z-30 h-full w-[220px] border-l border-ink/10 bg-white/95 px-3 pb-3 pt-12 shadow-soft dark:bg-slate-950/95">
