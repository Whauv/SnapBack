...
export async function startSession(mode: Mode, language: string, recapLength: RecapLength) {
...
export async function createRecap(sessionId: string, fromTimestamp: string, toTimestamp: string) {
  return request<{
    summary: string;
    keywords: string[];
